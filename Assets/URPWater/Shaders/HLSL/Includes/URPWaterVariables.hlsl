...
void InitializeVertexData(inout Varyings IN)
{
	...
	IN.normal = half4(0, 1, 0, 0);    // xyz: normal, w: viewDir.x
	IN.tangent = half4(0, 1, 0, 0);     // xyz: tangent, w: viewDir.y
	IN.bitangent = half4(0, 1, 0, 0);     // xyz: binormal, w: viewDir.z
